                ...
                <div class="content">
                    <div class = "card-ifo card-outline">
                        ...
                        <div class="card-tools"> 
                            ...
                            @if (count($data) > 0)
                                <a href="/exportSuhu/{{ $data[0]->id }}" data-mdc-auto-init="MDCRipple"
                                    class="btn btn-success">Download Report</a>
                            @endif        
                                {{-- <a href="{{url('export')}}" class="btn btn-success">Cetak</a> <br> <br> --}}
                            </div> 
                        </div> <br>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <a href="{{url ('editSuhu',$item -> id)}}"  > <i class="btn btn-xs btn-info">Edit</i></a>
                                        <a href="{{url ('delSuhu',$item -> id)}}" > <i class="btn btn-xs btn-danger">Hapus</i></a>
                                    </th> 
                                </tr>
