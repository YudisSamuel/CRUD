            ...
            <div class="container-fluid">
				...
				<div class="home-content">
					...
					<table class="table-responsive">
					 <thead>
                        <form id="demo-form2" action="{{ url('updateSuhu',$data ->id) }}" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name = "Data_Sensor" id="Data_Sensor" value ="{{$data -> Data_Sensor}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" name = "Waktu" id="Waktu" value ="{{$data -> Waktu}}">
                            </div> <br>
