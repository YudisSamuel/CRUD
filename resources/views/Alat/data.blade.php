            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Dashboard <small>Data Alat Sensor Pendeteksi Kebakaran</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="home-content">
					...
					<table class="table-responsive">
					 <thead>
                        <form id="demo-form2" action="Alat.data" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                            @csrf
                            <div class="mb-3">
